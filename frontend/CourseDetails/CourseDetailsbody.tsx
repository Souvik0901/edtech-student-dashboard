...
import instructor01 from '../../components/assets/images/avatar/05.jpg'
											...
											<div className="card mb-0 mb-md-4">
												<div className="row g-0 align-items-center">
													<div className="col-md-5">
														...
														<Image src={instructor01} className="img-fluid rounded-3" alt="instructor-image"/>
													</div>
								...
								<div className="col-md-6 col-lg-12">
									...
									<div className="card shadow p-2 mb-4 z-index-9">
										<div className="overflow-hidden rounded-3">
											<Image src={course08} className="card-img" alt="course image"/>
